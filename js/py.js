var sm, b, al, cx, ar, value, ad, bs, cs, dx, dy, sinv, bass = 1, treble = 1, audioPlayer,
    userAgent = navigator.userAgent;

function ld() {
    console.log("Load Done");
    console.log("%c欢迎来到陈星宇2011的奇妙灵堂 ", "font-family: dengxian;font-weight: 300;color: red;font-size: 100px;text-shadow: 0px 0px 6px #CCC;");
...
function freezeGif(img) {
    var width = img.width, height = img.height, canvas = createElement('canvas', function (clone) {
        clone.width = width;
        clone.height = height;
    }), attr, i = 0;
...
function freezeAllGifs() {
    return [].slice.apply(document.images).map(freezeGif);
}
